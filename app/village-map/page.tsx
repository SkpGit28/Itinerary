...
export default function VillageMapPage() {
  ...
  const downloadFramed = useCallback(async () => {
    ...
    try {
      ...
      const r = 12;
      ctx.beginPath();
      ctx.roundRect(PAD / 2, PAD / 2, canvas.width - PAD, canvas.height - PAD, r);
      ctx.stroke();
      ctx.restore();
      ...
      // Map image with slight rounded clip
      ctx.save();
      ctx.beginPath();
        ...
        <div className="w-full max-w-2xl space-y-8">
          ...
          <div className="text-center space-y-2">
            <h1
              ...
              style={{ fontFamily: 'Axiforma, var(--jakarta-font), system-ui, sans-serif' }}
            >
              Village Map Framer
            </h1>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="village" className="text-zinc-300 text-sm">
                Village name
              </Label>
              <Input
                id="village"
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 overflow-hidden shadow-xl">
                ...
                <div className="relative bg-zinc-900">
                  ...
                  <img
                    ...
                    onError={() => {
                      setError('Failed to load map image. Verify GOOGLE_MAPS_API_KEY is valid and the Maps Static API is enabled.');
                      setImageLoaded(true);
                    }}
                  />
                </div>
