...
export const SECTIONS: Section[] = [
  {
    id: 's1',
    index: 1,
    title: 'How you feel with Sush',
    description:
      'Nainu, think about how you normally feel when you are with Sush, not just during one bad day.',
  },
  {
    id: 's2',
    index: 2,
  ...
  },
  {
    ...
    description:
      'Relationships are not only about problems. Think about what Sush does well too.',
  },
  {
    id: 's7',
    index: 7,
    ...
    description:
      'Nainu, these questions may be uncomfortable. Please answer honestly. You are not being mean by telling the truth.',
  },
  {
    id: 's8',
    index: 8,
...
export const QUESTIONS: Question[] = [
  // ── Section 1 — How you feel with him ────────────────────────────────────
  {
    ...
    sectionId: 's1',
    displayNumber: '1',
    title: 'When you are with Sush, do you usually feel safe and comfortable?',
    required: true,
    type: 'segmented',
  ...
  },
  {
    ...
    sectionId: 's1',
    displayNumber: '5',
    title: 'Do you feel loved by Sush?',
    required: false,
    type: 'rating',
  ...
  // ── Section 2 — Arguments and anger ──────────────────────────────────────
  {
    ...
    sectionId: 's2',
    displayNumber: '7',
    title: 'When Sush gets angry, what do you usually feel?',
    required: true,
    type: 'multi',
    options: [
  ...
  },
  {
    ...
    sectionId: 's2',
    displayNumber: '14',
    title: 'What is the most difficult part when you argue with Sush?',
    required: false,
    type: 'text',
  ...
  // ── Section 3 — Trust and insecurity ─────────────────────────────────────
  {
    ...
    sectionId: 's3',
    displayNumber: '16',
    title: 'How much do you feel that Sush trusts you?',
    required: true,
    type: 'rating',
    rating: { min: 0, max: 10, minLabel: 'Not at all', maxLabel: 'Completely' },
    info: {
  ...
  },
  {
    ...
    sectionId: 's3',
    displayNumber: '22',
    title: "Do Sush's worries ever make you change normal things that you do?",
    required: false,
    type: 'segmented',
    options: YES_SOMETIMES_NO,
    info: {
  ...
  },
  {
    ...
    sectionId: 's4',
    displayNumber: '25',
    title: 'Does Sush expect you to act exactly the way he wants?',
    required: true,
    type: 'scale',
    options: FREQUENCY,
    info: {
  ...
  // ── Section 5 — Communication ────────────────────────────────────────────
  {
    ...
    sectionId: 's5',
    displayNumber: '32',
    title: 'Can you tell Sush when he hurts your feelings?',
    required: true,
    type: 'segmented',
    options: YES_SOMETIMES_NO,
    info: {
  ...
  // ── Section 6 — The positive side ────────────────────────────────────────
  {
    ...
    sectionId: 's6',
    displayNumber: '38',
    title: 'What does Sush do that makes you feel truly loved?',
    required: true,
    type: 'text',
  ...
  },
  {
    ...
    sectionId: 's6',
    displayNumber: '39',
    title: 'What is your favourite thing about being with Sush?',
    required: false,
    type: 'text',
  ...
  },
  {
    ...
    sectionId: 's7',
    displayNumber: '44',
    title: 'What does Sush do that hurts you the most?',
    required: true,
    type: 'text',
  ...
  },
  {
    ...
    sectionId: 's7',
    displayNumber: '48',
    title: 'If you could remove ONE thing Sush does, forever, what would it be?',
    required: true,
    type: 'text',
  ...
  },
  {
    ...
    displayNumber: '55',
    title:
      'If you could say ONE completely honest thing to Sush, and he would not be hurt, what would you say?',
    required: true,
    type: 'text',
    large: true,
  ...
  },
  {
    ...
    sectionId: 's9',
    displayNumber: '60',
    title: 'How would you score Sush as a partner, from 0 to 10?',
    required: true,
    type: 'rating',
  ...
  },
  {
    ...
    sectionId: 's9',
    displayNumber: '61',
    title: 'What is ONE thing you want Sush to understand after reading your answers?',
    required: true,
    type: 'text',
    large: true,
